...
public class DuplicateArray {
    ...
    // Вар. 2 внешни цикл запустить по числам от 1 до 10 и для каждого числа внутренним циклом посчитать, сколько раз
  ...
  //      return count;
    ...
    //метод должен подсчитать количество раз нахождения числа в массиве
