...
public class ShapeAppl {
    public static void main(String[] args) {
        ...
        double s = shapes[0].calcArea(shapes[0].getLength()) + shapes[1].calcArea(shapes[1].getLength()) + shapes[2].calcArea(shapes[2].getLength()) + shapes[3].calcArea(shapes[3].getLength());
        System.out.println("общая площадь = " + s);

        double p = shapes[0].calcPerimeter(shapes[0].getLength()) + shapes[1].calcPerimeter(shapes[1].getLength()) + shapes[2].calcPerimeter(shapes[2].getLength()) + shapes[3].calcPerimeter(shapes[3].getLength());
