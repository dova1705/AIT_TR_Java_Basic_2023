...
class DogTest {
    ...
    void binarySearchTest() {
       ...
       // Arrays.sort(dogs);//Сортировка по убыванию. Метод написан в классе Dog compareTo
        Comparator<Dog> dogComparator = Comparator.comparing(Dog :: getAge); // сортировка компаратором по возрасту, на вход подаем какой класс сортируем после двоеточие :: пишем по какому критерию сортируем (возраст, имя, иес id ....)
