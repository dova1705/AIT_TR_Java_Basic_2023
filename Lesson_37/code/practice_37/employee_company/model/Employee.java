...
public class Employee implements Comparable<Employee> {
    ...
    //поля, который описывают объект
    long id; //идентификатор
    String name; // имя
    int age; // возраст
    int experience; // стаж работы
    String education; //образование: 4 - real school, 3 - high school,  3 - technical  school, 3 - collage, 2 - university, 1 - PHD.
    ...
    public int compareTo(Employee o) {
        return this.name.compareTo(o.name); //сравнение по имени, в алфавитном порядке
    }
}
