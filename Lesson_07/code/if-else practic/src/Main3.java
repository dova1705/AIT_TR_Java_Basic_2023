...
public class Main3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Input first coefficient:"); // приглашение пользователя
        int a = scanner.nextInt();
        System.out.println("Input 2-nd coefficient:"); // приглашение пользователя
        int b = scanner.nextInt();
        System.out.println("Input 3-rd coefficient:"); // приглашение пользователя
