...
class CatTest {
    Cat[] cats; // объявили массив из объектов типа Cat
    ...
    void testSort(){
        ...
        Arrays.sort(cats); //метод sort - сортирует в "естественном" порядке который определен в классе Cat
    ...
    @Test
    void testBinarySearch(){ //бинарный поиск работает ТОЛЬКО с ОТСОРТИРОВЫННЫМ МАССИВОМ
